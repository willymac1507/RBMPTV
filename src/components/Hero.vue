...
<template>
  <div class="bg-gray-900 h-screen">
      ...
      <nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
        <div class="flex lg:flex-1">
          <a class="-m-1.5 p-1.5" href="#">
            ...
            <img alt="" class="h-8 w-auto hover:animate-spin" src="../assets/images/rbm.logo.svg"/>
          </a>
        </div>
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <a class="text-sm font-semibold leading-6 text-white" href="#">Log in <span
      ...
      <Dialog :open="mobileMenuOpen" as="div" class="lg:hidden" @close="mobileMenuOpen = false">
        ...
        <DialogPanel
          ...
          <div class="flex items-center justify-between">
            <a class="-m-1.5 p-1.5" href="#">
              <span class="sr-only">RB Mobile Pat Testing</span>
              <img alt="" class="h-8 w-auto" src="../assets/images/rbm.logo.svg"/>
            </a>
    ...
    <div class="absolute inset-0 isolate overflow-hidden pt-14 h-screen">
      <img alt="" class="absolute inset-0 -z-10 h-full w-full object-cover mix-blend-multiply"
      ...
      <div aria-hidden="true"
        ...
        <img alt="" class="opacity-50 h-screen" src="../assets/images/rbm.logo.svg">
      </div>
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 h-screen flex items-center">
        <div class="text-center mx-auto">
          <h1 class="text-4xl font-bold tracking-tight text-white sm:text-5xl uppercase">RB Mobile
            Pat Testing</h1>
          <p class="mt-6 text-lg leading-8 text-gray-300">Working hard so you can work safely.</p>
          <div class="mt-10 flex items-center justify-center gap-x-6">
            <a class="rounded-md bg-indigo-500 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"
               href="#">Contact Us</a>
          </div>
        </div>
      </div>
